...
Config.GasMaskNumber = 46 -- Nombre de casques que vous souhaitez utiliser comme masque à gaz (default = 46)

Config.CarLock = { 
    ControlKey          = 217,       -- K , voor andere keybinds kijk : https://docs.fivem.net/game-references/controls/
    NotCarOwner         = "Vous ne possédez pas les clés de ce véhicule..",
    CarLocked           = "Votre véhicule est ~r~verrouillé ~s~.",
    CarOpen             = "Votre véhicule est ~g~ouvert~s~.",
    BlinkingLighstON    = true,     -- Phares clignotants sur le véhicule d'ouverture et de fermeture
    CarBleepOnOpen      = true,     -- Bleep à l'ouverture du véhicule
    CarBleepOnClose     = true,     -- Bleep à la fermeture du véhicule
    CarBleepDistance    = 5.0,      -- Radius
    CarBleepVolume      = 0.5,      -- Volume
    TextBovenVoertuig   = false,     -- Lorsque cela est vrai, vous pouvez voir si le véhicule est «ouvert» ou «fermé» au-dessus de votre véhicule
    BegrenzerAAN        = true,     -- Option pour activer ou désactiver un limiteur
    BegrenzerKey        = 314,      -- Quel bouton pour le limiteur? par défaut: 314 = NUMPAD +, pour les autres raccourcis clavier: https://docs.fivem.net/game-references/controls/
}

--Liste touche debut
Config.keyMenuOpen = 337 --Liste des touche https://docs.fivem.net/docs/game-references/controls/ (Touche "X" par default)
--Liste touche fin

--Megaphone début
Config.keyMegaphone = 319 --Liste des touche https://docs.fivem.net/docs/game-references/controls/ (x = default)
Config.vehiculeMegaphone = {
  'police',
  'police2',
  'police3',
  'police4',
