                        ...
                        if show then
                            ...
                            if distance <= farDistance then  
                                ...
                                if distance <= 5 then
                                    ...
                                    if IsControlJustPressed(0, 38) and distance <= v.location[i].zoneSize then
                                        ESX.TriggerServerCallback('cylex_jobs:checkCount', function(count)
                                            if v.location[i].item["process"] == "pickup" or count > v.location[i].item["removeCount"]-1 then
                                                ...
                                                if v.location[i].progressbar["enable"] then
                                                    TriggerEvent("mythic_progbar:client:progress", {
                                                        ...
                                                        if not status then
                                                            ...
                                                            exports["mythic_notify"]:SendAlert("error", "Annulé.")
                                                        end
                                                ...
                                                exports["mythic_notify"]:SendAlert("error", "Vous n'avez pas assez d'items!")
                                            end
