...
client_scripts {
    ...
    '_data/*.lua',
    '_core/_menu/client/*.lua',
    '_core/_interaction/client/*.lua',
    '_core/_jobs/client/*.lua',
    'Config.lua'
}
...
server_scripts {
  ...
  '_data/_data-server/*.lua',
  '_core/_menu/server/*.lua',
  '_core/_interaction/server/*.lua',
  '_core/_jobs/server/*.lua'
}
