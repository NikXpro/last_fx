...
Config.Strings = {
	...
	JerryCanEmpty = "La jerry peut est vide",
	FullTank = "Réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E~w~ pour acheter une jerrycan pour ~g~$" .. Config.JerryCanCost,
	...
	NotEnoughCashJerryCan = "Pas assez d’argent pour remplir la jerrican",
	JerryCanFull = "La jerry peut est plein",
	TotalCost = "Coût",
}
