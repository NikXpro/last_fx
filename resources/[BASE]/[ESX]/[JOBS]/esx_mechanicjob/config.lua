...
Config.Zones = {
	...
	Garage = {
		Pos   = { x = 1744.97, y = 3324.98, z = 40.1 },
	...
	Craft = {
		Pos   = { x = 106.12, y = 6629.36, z = 30.79 },
		Size  = { x = 2.8, y = 2.8, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27
	},

	VehicleSpawnPoint = {
		Pos   = { x = 113.71, y = 6648.43, z = 30.49 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},
	...
	VehicleDelivery = {
		Pos   = { x = 133.43, y = 6666.28, z = 31.08 },
