...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		align    = 'top-left',
		elements = {
			{label = (_U('ems_menu_revive')..'<span>'..Emoticon.Seringue..'</span>'), value = 'revive'},
			{label = (_U('ems_menu_small')..'<span>'..Emoticon.Sang..'</span>'), value = 'small'},
			{label = (_U('ems_menu_big')..'<span>'..Emoticon.Sang..'</span>'), value = 'big'},
			{label = (_U('ems_menu_putincar')..'<span>'..Emoticon.Donner..'</span>'), value = 'put_in_vehicle'},
			{label = ('Facturation<span>'..Emoticon.Dollard..'</span>'),       value = 'billing'},
		}
	}, function(data, menu)
