...
Citizen.CreateThread(function()
	...
	exports['blip_info']:SetBlipInfoTitle(blip, "Legendary Motorsport", false)
	exports['blip_info']:SetBlipInfoImage(blip, "blips", "motorsport")
	exports['blip_info']:AddBlipInfoText(blip, "Type:", "~b~Entreprise")
	exports['blip_info']:AddBlipInfoText(blip, "Safe zone:", "~r~Non")
	exports['blip_info']:AddBlipInfoHeader(blip, "") -- Empty header adds the header line
	exports['blip_info']:AddBlipInfoText(blip, "Commisariat central des force de police de los santos")
end)
