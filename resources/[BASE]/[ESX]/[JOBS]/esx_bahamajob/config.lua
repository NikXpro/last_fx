...
Config.AuthorizedVehicles = {
    { name = 'rentalbus',  label = 'Vanilla bahama Bus' },
}

Config.Blips = {
    Blip = {
      Pos     = { x = -1390.46, y = -600.04, z = 30.32 },
      Sprite  = 93,
      Display = 4,
      Scale   = 1.0,
      Colour  = 26,
...
Config.Zones = {
    Cloakrooms = {
        Pos   = { x = -1381.06, y = -612.08, z = 29.82 },
    ...
    Vaults = {
        Pos   = { x = -1386.54, y = -608.62, z = 29.32 },
    ...
    Fridge = {
        Pos   = { x = -1391.04, y = -606.24, z = 29.32 },
...
--[[
    ...
    BossActions = {
        Pos   = { x = -1390.58, y = -600.43, z = 29.32 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 1,
    },
...
Config.TeleportZones = {
  EnterBarAvant = {
    Pos       = { x = -1382.26, y = -609.86, z = 29.82 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = "Appuyer sur E pour aller au comptoir avant.",
    Teleport  = { x = -1385.02, y = -606.47, z = 29.32 }
  },

  ExitBarAvant = {
    Pos       = { x = -1385.02, y = -606.47, z = 29.32 },
    Size      = { x = 1.2, y = 1.2, z = 0.1 },
    Color     = { r = 128, g = 128, b = 128 },
    Marker    = 1,
    Hint      = "Appuyer sur E pour sortir du comptoir avant.",
    Teleport  = { x = -1382.26, y = -609.86, z = 29.82 }
  },

  EnterBarArriere = {
    Pos       = { x = -1386.25, y = -627.48, z = 29.82 },
    Size      = { x = 2.0, y = 2.0, z = 0.2 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 1,
    Hint      = "Appuyer sur E pour aller au comptoir arriére.",
    Teleport  = { x = -1371.33, y = -625.97, z =  29.82 }
  },

  ExitBarArriere = {
    Pos       = { x = -1371.33, y = -625.97, z =  29.82 },
    Size      = { x = 2.0, y = 2.0, z = 0.2 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 1,
    Hint      = "Appuyer sur E pour sortir du comptoir arriére.",
    Teleport  = { x = -1386.25, y = -627.48, z = 29.82 }
  },
}
