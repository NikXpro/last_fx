...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bahama_actions', {
      title    = _U('bahama'),
      align    = 'top-left',
      elements = elements
    }, function(data, menu)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bahama_shop', {
            title    = _U('shop'),
            elements = elements
        }, function(data, menu)
...
Citizen.CreateThread(function()
    ...
    exports['blip_info']:SetBlipInfoTitle(blipCoord, "Bahama mamas west", false)
		exports['blip_info']:SetBlipInfoImage(blipCoord, "blips", "bahama")
		exports['blip_info']:AddBlipInfoText(blipCoord, "Type:", "~b~Entreprise")
		exports['blip_info']:AddBlipInfoText(blipCoord, "Safe zone:", "~r~Non")
		exports['blip_info']:AddBlipInfoHeader(blipCoord, "")
		exports['blip_info']:AddBlipInfoText(blipCoord, "La boite de nuit la plus réputé de la ville de Los Santos")
end)
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bahama_actions') then
