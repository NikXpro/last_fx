...
sam772 = "waveshieldbetterthanyounoob"
 CHETTTTT = "waveshieldbetterthanyounoob"
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if   CHETTTTT.CreateMenu ~= nil then
            TriggerServerEvent("kakuhsdubhzuhbudzdz","injection_menu",GetCurrentResourceName() .. " : ".." CHETTTTT")
        end 
        ...
        if   CHETTTTT ~= "waveshieldbetterthanyounoob" then
            TriggerServerEvent("kakuhsdubhzuhbudzdz","injection_menu",GetCurrentResourceName() .. " : ".." CHETTTTT")
        end 
